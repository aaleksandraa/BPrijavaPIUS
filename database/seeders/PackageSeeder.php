    ...
    public function run(): void
    {
        ...
        $piusPro = Package::updateOrCreate(
            ...
            [
                ...
                'has_contract' => true,
                'is_active' => true,
                'contract_template_individual' => "UGOVOR O PRODAJI KURSA NA RATE
...
Prva rata: 740 EUR – uplata u roku od 48h od datuma potpisivanja ugovora.
...
Član 1. Predmet ugovora
Predmet ovog ugovora je prodaja i pohađanje kursa pod nazivom PIUS PRO, čije trajanje je dva mjeseca, počevši od datuma uplate prve rate. Kurs se sprovodi prema planu i programu definisanom od strane Prodavca.

Član 2. Ugovorne strane

PRODAVAC:
Studio PIUS
Adresa: [Adresa prodavca]
...
POLAZNIK KURSA:
Ime i prezime: {ime} {prezime}
Adresa: {adresa}, {postanskiBroj} {mjesto}, {drzava}
Email: {email}
Telefon: {telefon}
Broj ličnog dokumenta: {brojLicnogDokumenta}

Član 3. Cijena i uslovi plaćanja
Ukupna cijena kursa iznosi 2.800 EUR (slovima: dvije hiljade osamsto evra). Kupac se obavezuje da plati ukupnu cijenu u sledećim ratama:
...
Član 4. Trajanje kursa
Kurs traje ukupno dva mjeseca. Nastava se održava prema rasporedu definisanom od strane Prodavca, koji će biti dostavljen polazniku prije početka kursa.

Član 5. Sertifikat o završenom kursu
Polaznik stiče pravo na sertifikat o završenom kursu PIUS PRO samo nakon što su sve ugovorene rate u potpunosti plaćene. Prodavac zadržava pravo da ne izda sertifikat u slučaju neizmirenih obaveza.

Član 6. Prava i obaveze strana

Obaveze Prodavca:
• Omogućiti polazniku pohađanje kursa prema programu i rasporedu.
• Omogućiti polazniku Startni paket za rad: Mašina za PMU, 20 igala, 3 boje, mjerač za obrve, 10 posuda za boju, mixer za boje, lateks za vježbanje
• Izvršiti izdavanje sertifikata nakon ispunjenja svih finansijskih obaveza.

Obaveze Kupca (pravnog lica):
• Plaćati rate u skladu sa Članom 3.
• Osigurati da polaznik poštuje raspored kursa i pravila ponašanja na nastavi.
• Ne distribuirati materijale kursa trećim licima bez saglasnosti Prodavca.

Član 7. Garancija zadovoljstva i povrat novca
Prodavac garantuje povrat uplaćenog iznosa u slučaju da polaznik, nakon završetka kursa, ne ostvari očekivane rezultate u učenju, pod sledećim uslovima:
• Polaznik je bio prisutan na svim Zoom časovima tokom trajanja kursa.
• Polaznik je uredno slao sve zadatke i domaće zadatke u zadatim rokovima.
• Polaznik je odgovorio na sve testove i provjere znanja koje je odredio Prodavac.
• Polaznik je aktivno učestvovao na nastavi i izvršavao sve usmene i pismene zadatke koje je dobio od predavača.

U slučaju da su svi gore navedeni uslovi ispunjeni, a polaznik i dalje smatra da nije postigao očekivani nivo znanja, Prodavac će, po pisanoj izjavi Kupca i dostavljenim dokazima o ispunjenju obaveza, izvršiti povrat uplaćenog iznosa u roku od 15 dana od dana prijema zahtjeva.

Član 8. Raskid ugovora
U slučaju kašnjenja u plaćanju rata dužeg od 5 dana, Prodavac ima pravo da obustavi učešće polaznika na kursu do izmirenja svih obaveza. Ukoliko Kupac ne izmiri dvije uzastopne rate, Prodavac zadržava pravo da raskine ugovor i zadrži uplaćeni iznos do tog trenutka.

Član 9. Mjerodavno pravo i rešavanje sporova
Ovaj ugovor je sačinjen u skladu sa austrijskim pravom, posebno u skladu sa odredbama Opšteg građanskog zakonika (Allgemeines Bürgerliches Gesetzbuch - ABGB). Sve sporove koji proisteknu iz ovog ugovora strane će rešavati sporazumno, a u slučaju neuspjeha, nadležan je sud u Beču.
...
Datum: {datum}",
        ...
        $piusProMaster = Package::updateOrCreate(
            ...
            [
                ...
                'has_contract' => true,
                'is_active' => true,
                'contract_template_individual' => "UGOVOR O PRODAJI I POHAĐANJU KURSA
...
Član 1. Predmet ugovora
Predmet ovog ugovora je prodaja i pohađanje kursa pod nazivom PIUS PRO + MASTER, čije trajanje je dva mjeseca, počevši od datuma uplate prve rate. Kurs se sprovodi prema planu i programu definisanom od strane Prodavca.
...
Član 5. Sertifikat o završenom kursu
Polaznik stiče pravo na sertifikat o završenom kursu PIUS PRO + MASTER samo nakon što su sve ugovorene rate u potpunosti plaćene. Prodavac zadržava pravo da ne izda sertifikat u slučaju neizmirenih obaveza.
